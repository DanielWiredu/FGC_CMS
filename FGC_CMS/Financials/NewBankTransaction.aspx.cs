...
namespace FGC_CMS.Financials
{
    public partial class NewBankTransaction : MasterPageChange
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            string query = "insert into BankTransactions(transdate,transname,transtype,transmode,currency,amount,transbank,chequeno,valuedate,remarks,preparedby,payyyyymm) ";
            query += "values(@transdate,@transname,@transtype,@transmode,@currency,@amount,@transbank,@chequeno,@valuedate,@remarks,@preparedby,@payyyyymm)";
