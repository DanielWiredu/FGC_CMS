<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="EditVisitor.aspx.cs" Inherits="FGC_CMS.Main.EditVisitor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="box-body">
                 ...
                 <div class="row">
                    ...
                    <asp:Button runat="server" CssClass="btn btn-danger" Text="Exit" PostBackUrl="~/Main/Visitors.aspx" CausesValidation="false" />  
                    <asp:Button ID="btnUpdate" CssClass="btn btn-success" runat="server" Text="Update" CausesValidation="true" OnClick="btnUpdate_Click" />         
                </div>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </div><!-- /.box-body -->
