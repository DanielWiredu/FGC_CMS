...
namespace FGC_CMS.Main.MemberReports
{
    ...
    {
        rptMembersList rpt = new rptMembersList();
        ...
        protected void ReportDocument_Load(object sender, EventArgs e)
        {
            ...
            adapter = new SqlDataAdapter("select memberid, surname, firstname, Othername, mobile, regdate, gender from members where regdate between '" + sdate + "' and '" + edate + "'", connection);
