...
{
    public partial class MembersByCommittee : System.Web.UI.Page
    {
        rptMembersByCommittee rpt = new rptMembersByCommittee();
        ...
        protected void ReportDocument_Load(object sender, EventArgs e)
        {
            ...
            committee = Session["committee"].ToString();
            ...
            adapter = new SqlDataAdapter("select committee, memberid, surname, firstname, Othername, mobile, regdate, gender from members where committee like '" + committee + "%' and regdate between '" + sdate + "' and '" + edate + "'", connection);
