...
{
    public partial class MembersByMinistry : System.Web.UI.Page
    {
        rptMembersByMinistry rpt = new rptMembersByMinistry();
        ...
        protected void ReportDocument_Load(object sender, EventArgs e)
        {
            ...
            ministry = Session["ministry"].ToString();
            ...
            adapter = new SqlDataAdapter("select ministry, memberid, surname, firstname, Othername, mobile, regdate, gender from members where ministry like '" + ministry + "%' and regdate between '" + sdate + "' and '" + edate + "'", connection);
