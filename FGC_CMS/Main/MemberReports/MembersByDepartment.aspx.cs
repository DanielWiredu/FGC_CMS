...
namespace FGC_CMS.Main.MemberReports
{
    public partial class MembersByDepartment : System.Web.UI.Page
    {
        ...
        protected void ReportDocument_Load(object sender, EventArgs e)
        {
            ...
            adapter = new SqlDataAdapter("select department, memberid, surname, firstname, Othername, mobile, regdate from members where department like '" + department + "%' and regdate between '" + sdate + "' and '" + edate + "'", connection);
