...
namespace FGC_CMS.Main.FinancialReports.BankRecords
{
    public partial class BankRecords : System.Web.UI.Page
    {
        ...
        protected void BankTransactionsReport_Load(object sender, EventArgs e)
        {
            ...
            adapter = new SqlDataAdapter("select transdate,transname,transtype,transmode,currency,amount,transbank from banktransactions where currency = '" + currency + "' and transdate between '" + sdate + "' and '" + edate + "' order by transdate", connection);
