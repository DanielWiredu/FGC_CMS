        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (reader.Read() && !String.IsNullOrEmpty(reader["visitorid"].ToString()))
                {
                    ...
                    visitorid = visitorid.Substring(3, 4);
                ...
                switch (visitorid.Length)
                {
                    ...
                    case 3:
                        ...
                        break;
                    default:
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "popup", "toastr.error('Maximum VisitorID has been reached...Cannot Continue', 'Error')", true);
                        return;
                }
                visitorid = "VDP" + visitorid + "-" + nowyear;

                query = "INSERT INTO Visitors(visitorid,surname,othername,gender,resaddress,telephone,email,visittype,visitdate,createddate,createdby) ";
                query += "VALUES(@visitorid,@surname,@othername,@gender,@resaddress,@telephone,@email,@visittype,@visitdate,@createddate,@createdby)";
                ...
                command.Parameters.Add("@visittype", SqlDbType.VarChar).Value = rdVisitType.SelectedValue;
