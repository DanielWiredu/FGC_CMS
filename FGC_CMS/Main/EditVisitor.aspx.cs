...
namespace FGC_CMS.Main
{
    public partial class EditVisitor : MasterPageChange
    {
            ...
            if (!IsPostBack)
            {
                ...
                try
                {
                    ...
                    if (reader.Read())
                    {
                        ...
                        rdVisitType.SelectedValue = reader["visittype"].ToString();
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            query += "telephone=@telephone,email=@email,visittype=@visittype,visitdate=@visitdate WHERE visitorid=@visitorid";
            command = new SqlCommand(query, connection);
