<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProgramStackChart.aspx.cs" Inherits="FGC_CMS.Setups.ProgramStackChart" %>
        ...
        <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
         ...
         <div class="box box-default">
            ...
            <PlotArea>
                ...
                <XAxis DataLabelsField="SERVICE">
                    <LabelsAppearance RotationAngle="25">
                        <TextStyle FontSize="16" />
                    </LabelsAppearance>
                    <TitleAppearance Text="Programs">
