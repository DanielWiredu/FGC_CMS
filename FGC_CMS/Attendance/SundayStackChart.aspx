<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SundayStackChart.aspx.cs" Inherits="FGC_CMS.Setups.SundayStackChart" %>
        ...
        <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
         ...
         <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">Sunday Service Attendance Chart </h3>
            ...
            <PlotArea>
                <Series>
                    <telerik:ColumnSeries DataFieldY="MALES" Stacked="true" Name="Males" >
                        <LabelsAppearance Visible="false"></LabelsAppearance>
                        <TooltipsAppearance Color="White" />
                    </telerik:ColumnSeries>
                    <telerik:ColumnSeries DataFieldY="FEMALES" Stacked="true" Name="Females" >
                        <LabelsAppearance Visible="false"></LabelsAppearance>
                        <TooltipsAppearance Color="White" />
                    </telerik:ColumnSeries>
                    <telerik:ColumnSeries DataFieldY="YOUTH" Stacked="true" Name="Youth">
                        <LabelsAppearance Visible="false"></LabelsAppearance>
                        <TooltipsAppearance Color="White" />
                    </telerik:ColumnSeries>
                    <telerik:ColumnSeries DataFieldY="CHILDREN" Stacked="true" Name="Children">
                        <LabelsAppearance Visible="false"></LabelsAppearance>
                        <TooltipsAppearance Color="White" />
                    </telerik:ColumnSeries>
                    
                </Series>
                <XAxis DataLabelsField="SERVICEKIND">
                    <LabelsAppearance RotationAngle="25">
                        <TextStyle FontSize="16" />
                    </LabelsAppearance>
                    <TitleAppearance Text="Service Kind">
            ...
            <ChartTitle Text="Sunday Service Attendance Chart">
                <Appearance>
                    <TextStyle FontSize="24" Bold="true" />
                </Appearance>
            </ChartTitle>
        </telerik:RadHtmlChart>
                <asp:SqlDataSource ID="chartSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT SERVICEKIND, SUM(MALES) AS MALES, SUM(FEMALES) AS FEMALES, SUM(YOUTH) AS YOUTH, SUM(CHILDREN) AS CHILDREN from ATTENDANCE WHERE SERVICE LIKE '%Sunday%' AND (SERVICEDATE BETWEEN @SDATE AND @EDATE) GROUP BY SERVICEKIND">
                    <SelectParameters>
