<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LineGraph.aspx.cs" Inherits="FGC_CMS.Attendance.LineGraph" %>
    ...
    <div>
       <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        ...
        <div class="box box-default">
            ...
            <PlotArea>
                <Series>
                    <telerik:LineSeries DataFieldY="MALES" Name="MALE" MissingValues="Interpolate">
                        <LineAppearance Width="3" />
                         <Appearance>
                             <FillStyle BackgroundColor="Blue" />
                         </Appearance>
                         <MarkersAppearance MarkersType="Square"/>
                         <LabelsAppearance Color="DarkRed" DataField="MALES" Position="Left" DataFormatString="{0:#}" Visible="false">
                              <TextStyle Bold="true" FontSize="12" />
                         </LabelsAppearance>
                        <TooltipsAppearance Color="Yellow" DataFormatString="{0:#}"></TooltipsAppearance>
                    </telerik:LineSeries>
                     <telerik:LineSeries DataFieldY="FEMALES" Name="FEMALE" MissingValues="Interpolate">
                          <LineAppearance Width="3" />
                         <Appearance>
                             <FillStyle BackgroundColor="OrangeRed" />
                         </Appearance>
                         <MarkersAppearance MarkersType="Square"/>
                         <LabelsAppearance Color="DarkRed" DataField="FEMALES" Position="Left" DataFormatString="{0:#}" Visible="false">
                              <TextStyle Bold="true" FontSize="12" />
                         </LabelsAppearance>
                        <TooltipsAppearance Color="Yellow" DataFormatString="{0:#}"></TooltipsAppearance>
                    </telerik:LineSeries>
                    <telerik:LineSeries DataFieldY="YOUTH" Name="YOUTH" MissingValues="Interpolate">
                         <LineAppearance Width="3" />
                         <Appearance>
                             <FillStyle BackgroundColor="Green" />
                         </Appearance>
                         <MarkersAppearance MarkersType="Square"/>
                         <LabelsAppearance Color="DarkRed" DataField="YOUTH" Position="Left" DataFormatString="{0:#}" Visible="false">
                              <TextStyle Bold="true" FontSize="12" />
                         </LabelsAppearance>
                        <TooltipsAppearance Color="Yellow" DataFormatString="{0:#}"></TooltipsAppearance>
                    </telerik:LineSeries>
                    <telerik:LineSeries DataFieldY="CHILDREN" Name="CHILDREN" MissingValues="Interpolate">
                         <LineAppearance Width="3" />
                         <Appearance>
                             <FillStyle BackgroundColor="Purple" />
                         </Appearance>
                         <MarkersAppearance MarkersType="Square"/>
                         <LabelsAppearance Color="DarkRed" DataField="CHILDREN" Position="Left" DataFormatString="{0:#}" Visible="false">
                             <TextStyle Bold="true" FontSize="12" />
                         </LabelsAppearance>
                        <TooltipsAppearance Color="Yellow" DataFormatString="{0:#}"></TooltipsAppearance>
                    </telerik:LineSeries>
