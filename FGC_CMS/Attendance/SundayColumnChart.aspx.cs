...
{
    public partial class SundayColumnChart : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                RadHtmlChart2.ChartTitle.Text = "Sunday Service Attendance Chart (" + dpSdate.SelectedDate.Value.ToString("dd-MMM-yyyy") + " To " + dpEdate.SelectedDate.Value.ToString("dd-MMM-yyyy") + ")";
            }
        }
        ...
        protected void btnRun_Click(object sender, EventArgs e)
        {
            ...
            RadHtmlChart2.ChartTitle.Text = "Sunday Service Attendance Chart (" + hfSdate.Value + " To " + hfEdate.Value + ")";
        }
    }
}