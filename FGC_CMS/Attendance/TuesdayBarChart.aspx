<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TuesdayBarChart.aspx.cs" Inherits="FGC_CMS.Setups.TuesdayBarChart" %>
          ...
          <div class="box box-default">
            ...
            <PlotArea>
                <Series>
                    ...
                    <telerik:BarSeries DataFieldY="YOUTH" Name="Youth">
                        <LabelsAppearance Visible="true">
                            <TextStyle FontSize="14" Bold="true" />
                        </LabelsAppearance>
                        <TooltipsAppearance Color="White" />
                    </telerik:BarSeries>
                    <telerik:BarSeries DataFieldY="CHILDREN" Name="Children" >
                        <LabelsAppearance Visible="true">
                            <TextStyle FontSize="14" Bold="true" />
                        </LabelsAppearance>
                        <TooltipsAppearance Color="White" />
            ...
            <ChartTitle Text="Tuesday Service Attendance Chart">
                ...
                <asp:SqlDataSource ID="chartSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT SUM(MALES) AS MALES, SUM(FEMALES) AS FEMALES, SUM(YOUTH) AS YOUTH, SUM(CHILDREN) AS CHILDREN from ATTENDANCE WHERE SERVICE LIKE '%Tuesday%' AND (SERVICEDATE BETWEEN @SDATE AND @EDATE)">
                    <SelectParameters>
