<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="EditAttendance.aspx.cs" Inherits="FGC_CMS.Setups.EditAttendance" %>
        ...
        <tr>
         ...
         <tr >
           ...
           <td style="padding-bottom:2px"><asp:TextBox ID="txtComments" runat="server" Width="300px" TextMode="MultiLine" Rows="5"></asp:TextBox>
                    ...
                    <asp:Button ID="btnUpdate" CssClass="btn btn-success" runat="server" Text="Save" OnClick="btnUpdate_Click"/>         
                </div>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </div><!-- /.box-body -->
