...
namespace FGC_CMS.Setups
{
    public partial class Services : MasterPageChange
    {
        ...
        protected void serviceGrid_ItemCommand(object sender, GridCommandEventArgs e)
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "", "newserviceModal();", true);
                e.Canceled = true;
            }
            if (e.CommandName == "Edit")
            {
                ...
                ScriptManager.RegisterStartupScript(this, this.GetType(), "popup", "editserviceModal();", true);
                e.Canceled = true;
            }
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (rows == 1)
                {
                    ...
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "popup", "closenewserviceModal();", true);
                    serviceGrid.Rebind();
                    txtService.Text = "";
                }
                command.Dispose();
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (rows == 1)
                {
                    ...
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "popup", "closeeditserviceModal();", true);
                    serviceGrid.Rebind();
                }
                command.Dispose();
            }
