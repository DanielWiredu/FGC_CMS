...
namespace FGC_CMS.Setups
{
    public partial class Occupation : MasterPageChange
    {
        ...
        protected void occupationGrid_ItemCommand(object sender, GridCommandEventArgs e)
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "", "newoccModal();", true);
                e.Canceled = true;
            }
            if (e.CommandName == "Edit")
            {
                ...
                ScriptManager.RegisterStartupScript(this, this.GetType(), "", "editoccModal();", true);
                e.Canceled = true;
            }
        }
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (rows == 1)
                {
                    ...
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "popup", "closenewoccModal();", true);
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (rows == 1)
                {
                    ...
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "popup", "closeeditoccModal();", true);
                    occupationGrid.Rebind();
                }
                command.Dispose();
            }
